...
def extract_small_dataset(input, output, n=10, contrast_list=None, include_derivatives=True,
    ...
    # copy README
    in_dataset_readme = Path(input, "README")
    out_dataset_readme = Path(output, "README")
    shutil.copyfile(str(in_dataset_readme), str(out_dataset_readme))
